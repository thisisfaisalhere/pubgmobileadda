            ...
            <div class="container-2">
				<?php if(isset($_SESSION['confirm'])) : ?>
					...
					<table>
						...
						<tr>
							<td>Team Name:</td>
							<td><?php echo $_SESSION['team']; ?></td>
						</tr>
						<tr>
							<td>Team Leader:</td>
							<td><?php echo $_SESSION['leader']; ?></td>
						</tr>
						<tr>
							<td>Contact No:</td>
						...
						<tr>
							<td>Team Members:</td>
							<td><?php echo $_SESSION['member1']; echo ", "; echo $_SESSION['member2']; echo ", "; echo $_SESSION['member3']; ?></td>
						</tr>
						<tr>
							<td>Amount:</td>
					...
					<form method="post" action="pgRedirect.php">
						...
						<input type="hidden" id="CUST_ID" tabindex="2" maxlength="12" size="12" 
							...
							value=<?php echo $_SESSION['leader']; ?> ></td>
